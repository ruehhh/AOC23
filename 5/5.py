...
m1 = [listize(z) for z in chunks[1].strip(alpha).split('\n')]
m2 = [listize(z) for z in chunks[2].strip(alpha).split('\n')]
m3 = [listize(z) for z in chunks[3].strip(alpha).split('\n')]
m4 = [listize(z) for z in chunks[4].strip(alpha).split('\n')]
m5 = [listize(z) for z in chunks[5].strip(alpha).split('\n')]
m6 = [listize(z) for z in chunks[6].strip(alpha).split('\n')]
m7 = [listize(z) for z in chunks[7].strip(alpha).split('\n')]
...
print(f"Part 2: {sorted([(mapping(x, totalmap),x) for x in potential_seeds])[0][0]}")
